        ...
        <TerminalWindow>
            ...
            {typingText === 'sudo lug' ? (
                <div>
                    ...
                    <span
                        style={{ color: Colors.nord11 }}
                        className='typeWriteSecondText'
                    >
                        {' '}
                        {typingSecondText}{' '}
                    </span>
                    ...
                    {typingSecondText === '***************' ? (
                        <div>
                            ...
                            The 'Linux Club' of VIT, Chennai was created to
                            Spread the awareness of Free and Open Source
                            Software (FOSS) through Linux flavours. It believes
                            in developing collaborative open-source projects.
                            <br />
                            It encourages users to understand the systems and
                            softwares they use on a fundamental level. Which can
                            be achieved only using non-proprietary tools.
                            <br />
                            It aims to get members to contribute to FOSS, make
                            them more industry ready and to promote GNU/Linux in
                            General.
                            <br />
