      ...
      <div className="bg-transparent font-space">
        <div className="text-gray-300 container  mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
          ...
          <p className="max-w-2xl font-space text-xl text-gray-400 md:text-2xl">
            The Linux Club held a successful event titled "Demystifying Google
            Summer of Code (GSoC)." Aimed at providing guidance to students
            interested in participating in GSoC, the event featured Beleswar
            Prasad Padhi, the President of the Linux Club and a GSoC participant
            who has contributed to the renowned Metasploit cybersecurity
            framework.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="flex flex-col justify-center">
              ...
              <p className=" text-2xl text-gray-400 md:pr-10">
                Beleswar Prasad Padhi, leveraging his own experience, offered
                valuable advice on choosing organizations, assessing required
                skills, and even demonstrated bug-fixing through a live demo.
              </p>
              ...
              <div className="grid gap-4 mx-4 sm:grid-cols-12">
                <div className="col-span-12 sm:col-span-3">
                  <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-violet-400">
                    <h5 className="text-2xl font-semibold">GSOC Made Easy</h5>
                ...
                <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                  <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-blue-400">
                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-400">
                      ...
                      <p className="mt-3">
                        With an impressive turnout of over 100 participants from
                        VIT Chennai, the event became a platform for sharing
                        insights on how to embark on a GSoC journey.
                      </p>
                    </div>
                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-400">
                      ...
                      <p className="mt-3">
                        Understanding the importance of accessibility, the Linux
                        Club ensured that the event's material, including
                        presentation slides (PPTs), was distributed via email
                        and shared on their social media channels. This
                        initiative allowed those who couldn't attend the event
                        to catch up on the valuable information shared. Beyond
                        the one-day event, the Linux Club continued to support
                        participants by offering ongoing guidance and necessary
                        details for their GSoC preparations.
                      </p>
                    </div>
                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-400">
