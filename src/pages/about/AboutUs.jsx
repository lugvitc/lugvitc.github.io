        ...
        <div className="sm:w-1/2 p-5 pr-10 flex justify-center">
          <div className="text">
            ...
            <p className="text-white 00">
              ...
              dolor sit, amet consectetur adipisicing elit. Dicta ducimus
              numquam, voluptas possimus, odit repellendus ea, nobis nam porro
              earum corporis eos itaque consequuntur tempora quis. Maxime enim
              delectus nobis.
            </p>
          </div>
        </div>
            ...
            <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
              <div className="lg:max-w-md">
                <div className="px-4 pl-4 mb-6 border-l-4 border-blue-500">
                  <span className="text-sm text-gray-600 uppercase dark:text-gray-400"></span>
                ...
                <div className="flex flex-wrap items-center">
                  <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div className="p-6 bg-[#1A1920] ">
                      ...
                      <p className="mt-4 mb-2 text-3xl font-bold  dark:text-gray-400">
                        2097
                      </p>
                  ...
                  <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div className="p-6 bg-[#1A1920] ">
                      ...
                      <h2 className="text-sm  dark:text-gray-400">Volunteer</h2>
                    </div>
                  </div>
                  <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div className="p-6 bg-[#1A1920] ">
                      ...
                      <h2 className="text-sm  dark:text-gray-400">Timing</h2>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-full px-4 mb-10 xl:w-1/2 lg:mb-8">
              ...
              <ul class="mb-10">
                ...
                <li class="flex items-center mb-4 text-base text-gray-600 dark:text-gray-400">
                  ...
                  illo consequuntur iusto fugiat asperiores accusamus molestias
                  magni quod repellendus. Obcaecati!
                </li>
                <li class="flex items-center mb-4 text-base text-gray-600 dark:text-gray-400">
                  <span class="mr-3 text-white  ">
                    <svg
