...
export default function Registration() {
    ...
    return (
        <TerminalWindow title='Registration'>
            <TerminalPrompt path='~/rescue-tux'>cd ./register</TerminalPrompt>
            <TerminalPrompt path='~/rescue-tux/register'>
                sudo ./registration --rt22
            </TerminalPrompt>
            Sorry, but the registrations have closed. Stay tuned to know when a
