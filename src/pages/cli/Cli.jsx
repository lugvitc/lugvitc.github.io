    ...
    switch (command) {
      case "help":
        ...
        <ul>
          ...
          <li>event-list: returns the list of all events conducted  by linux club till now</li>
          <li>[name of event] : returns information about the event</li>
          <li>learn-linux-text: returns some basic linux commands</li>
          <li>learn-linux-video: returns link to video tutorials of Linux made by our Linux Experts</li>
      ...
      case "fun":
        ...
        response= <div>
        < a href="https://www.youtube.com/watch?v=1J10xyPTE4I" target="_blank"> Cl1Ck m3</a>
        <br/>
        < a href="https://www.youtube.com/watch?v=OF_5EKNX0Eg" target="_blank"> Cl1Ck m3</a>
        <br/>
        < a href="https://www.youtube.com/watch?v=gCRzng7LsQI" target="_blank"> Cl1Ck m3</a>
        <br/>
        < a href="https://www.youtube.com/watch?v=6KJpy9DRzfY" target="_blank"> Cl1Ck m3</a>
        <br/>
        < a href="https://www.youtube.com/watch?v=2zpCOYkdvTQ" target="_blank"> Cl1Ck m3</a>
        </div>
        break;

      
      case "learn-linux-video":
        response = <a href="https://www.youtube.com/watch?v=nZDx0dSeg6w" target="_blank">Click here!</a> 
        break;
      ...
      case "learn-linux-text":
        ...
        <ul>
          ...
          <li>cd: Change the current directory.
          cd directory_name</li>
          <li>pwd: Print the current working directory.</li>
          <li>mkdir: Create a new directory.
          mkdir new_directory</li>
          <li>rm: Remove files or directories.
          rm file_name</li>
          <li>cp: Copy files or directories.
          cp source destination</li>
          <li> mv: Move or rename files or directories.
          mv old_name new_name</li>
          <li>touch: Create an empty file or update the access and modification times of a file.
          touch filename</li>
          <li>cat: Display the contents of a file.
          cat filename</li>
          <li>echo: Display a message or concatenate files.
          echo "Hello, Linux!"</li>
