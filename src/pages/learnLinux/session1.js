...
export default function Session1() {
    return (
        <>
            <section>
                <h2 style={{color: "orange"}}>What is Linux</h2>
                <ul>
                    <li>
            ...
            <section>
                <h2 style={{color:"orange"}}>Linux Distributions</h2>
	        ...
	        <br/><br/>
	        <center><img src={linuxFamilyTree}/></center>
                <br/><br/>
	        <ul>
	            <li>
	                 The very first linux based OS is the GNU Linux.
	            </li>
	            <li>
	                 Linux is the kernel, GNU Linux is the OS.
	            </li>
	            <li>
	                 Major parent Linux distros in the family tree are: Debian, Slackware, Red Hat, Arch etc.
	            </li>
	            <li>
	                 All the distros under the same family use the same package manager.
	            </li>
	        </ul>
                <h3>Which distribution to Choose?</h3>
                As seen in the Linux family tree, there are tons of Linux distros.
	        So which distro is the right one for you? The best answer is to try 
	        it out yourself. When you switch between distros and use a couple 
	        of them, you get to know which one is the best for your usage. 
	        Whether its gaming, productivity, customization, cybersecurity 
	        or just an easier dev experience, each distro has something unique 
	        to offer. So just as a heads up, we have provided a list of the 
	        most popular distributions and their advantages below which should
	        help you in determining the right distribution for yourself :
                <ol>
                    <li>
                        Debian:
                        <ul>
	            ...
	            <li>
	                ...
	                <ul>
	                    ...
	                    <li>
	                        Designed for advanced users who understand 
	                        and configure their own system requirements
	                    </li>
	                    <li>Dedicated Arch User Repository (AUR) which has
	                        almost all software packages</li>
	        ...
	        Read more about the linux distributions and their usage in the below links.
	        <br />
            ...
            <section>
                <h2 style={{color:"orange"}}>Why do we need it?</h2>
	        ...
	        Now, the installation process of every Linux distribution is different.
	        Some distros would complete the entire installation process through GUI
	        (like Ubuntu), whereas some would require you to complete the installation 
	        manually through every step (like Arch).
	        Installing a distro can be done in two ways:
	        <br /><br />
	        <ol>
	            <li>Dual Boot: Here, you partition your hard drive to make your physical
	                computer use 2 OS directly. The first is the OS you are currently in,
	                and the second one is the Linux distro you are installing. This is a 
	                tougher way but it is way more efficient than using a Virtual Machine.
	                Using Linux in Dual boot will give you far better control than in Virtual
	                Machine. But it can get harder to use the distro for everyday purposes if 
	                you are not much acquainted with linux (You can even break your software and
		        now your computer wont open until you re-install the OS). Thus, our advice for 
	                this tutorial would be to go with a Linux Virtual Machine and once you are well
	                acquainted with using Linux, you can switch to this Dual Boot option. Its fun!
	                We have attached a few resources, which you can refer to install some common 
	            ...
	            <li>Virtual Machine: This is a relatively simpler method to install a linux distro in
		        your system. Here, as the name suggests, you use the Linux distribution virtually. 
		        That is, the Linux distro runs on top of your current OS and this is achieved by 
	                the usage of a Virtual Machine Monitor (like VirtualBox or VMWare etc.). Here, you 
	                do not have to worry about breaking your software. Because, everything can be restored
	                to its initial state easily. Thus, VMs are a great way to experiment and learn when you
	                are using Linux for the first time. After you are well acquainted with using a distro
	                virtually, you can switch to the Dual Boot option :D
	                 We have attached a few resources, which you can refer to install some common 
