    ...
    return (
        <TerminalWindow title='Step 2'>
		  ...
		  values.prefDept === 'Media Department' ? 
			  <div>
		    <div className='form-textarea'>
                    <label> Do you have prior experience in Designing or Photography? If so, specify where you worked. </label>
                    <textarea
                        rows='6'
		  ...
		  values.prefDept === 'Content Department' ? 
			  <div>
		    <div className='form-textarea'>
                    <label> Do you have prior experience in writing content for events or social media handles? If so, specify where you worked. </label>
                    <textarea
                        rows='6'
