...
export default function TopBar({ refer, topBarLinks }) {
  ...
  const [onOpenState, setOnOpenState] = useState(false);

  const onClickHamburgerHandler = () => {
    setOnOpenState(!onOpenState);
  };
      ...
      <header ref={refer} className={`${styles.index} ${util.noSelection}`}>
        <div className={styles.contents}>
          ...
          <div className={styles.icons_media}>
            <div className={styles.hamburger} onClick={onClickHamburgerHandler}>
              <svg
