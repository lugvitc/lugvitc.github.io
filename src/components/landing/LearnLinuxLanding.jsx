    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center font-space my-5 py-5">
        ...
        <p class="max-w-5xl px-5 mt-2 text-md font-black leading-tight text-center text-white sm:mt-10 sm:px-0 sm:text-lg">
          Embrace the Penguin: Your Gateway to Linux Expertise. Lorem ipsum
          dolor sit amet consectetur adipisicing elit. Molestiae animi quaerat
          voluptatibus eius eligendi voluptate commodi architecto voluptas
          distinctio hic repellendus, veniam laborum totam nemo ex! Dicta fugiat
          animi odio!
        </p>
      </div>
    </>
