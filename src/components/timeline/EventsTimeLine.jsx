            ...
            <div class="bg-transparent  text-white  col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              >
                <p>
                  ...
                  <b className="text-light-green-300">sudo adrenaline-foss-day</b>
                </p>
                {/* <br />   */}
                <p>
                ...
                <p>
                  ...
                  <b className="text-light-green-300">cat adrenaline-foss-day.sh </b>
                </p>
                <p>On March 17, 2022, Adrenaline/FOSS Day unfolded as a vibrant one-day event, offering participants the opportunity to showcase their prowess in open-source technologies. The event served as a forum where participants could present their innovative projects to an industry expert.  
                </p>
                <br />
                
                <NavLink  className="text-light-green-300 underline " to={paths.adrenaline}>Read more here...</NavLink>
                <br />
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-transparent  text-white  col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              ...
              >
                ...
                <p>On the 21st of August 2022, the Linux Club organized the Rescue The Tux event, generously sponsored by GeeksForGeeks. This engaging gathering drew the participation of approximately 180 attendees, immersing them in a day filled with Linux expertise and challenges.  
                </p>
                <br />
                <NavLink  className="text-light-green-300 underline " to={paths.rescuethetux}>Read more here...</NavLink>
                <br />
          ...
          <div class="flex flex-row-reverse md:contents">
            <div class="bg-transparent  text-white  col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              >
                ...
                <p>In partnership with The Tech-Researchers Club, the Linux Club at VIT Chennai orchestrated the Cyber-0-Day event spanning from the 24th to the 25th of September 2022. With the generous sponsorship of Rapido, the event attracted the participation of approximately 100 enthusiastic individuals, forming teams of 1-3 members each.  
                </p>
                <br />
                <NavLink  className="text-light-green-300 underline " to={paths.cyberOday}>Read more here...</NavLink>
                <br />
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-transparent  text-white  col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              ...
              >
                ...
                <p>The Linux Club held a successful event titled "Demystifying Google Summer of Code (GSoC)." Aimed at providing guidance to students interested in participating in GSoC, the event featured Beleswar Prasad Padhi, the President of the Linux Club and a GSoC participant who has contributed to the renowned Metasploit cybersecurity framework.  
                </p>
                <br />
                <NavLink  className="text-light-green-300 underline " to={paths.gsocmadeeasy}>Read more here...</NavLink>
                <br />
          ...
          <div class="flex flex-row-reverse md:contents">
            <div class="bg-transparent  text-white  col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              >
                ...
                <p>The Linux Club organized a highly successful two-day event, "Hackers Horizon" on 11th and 12th February 2023, featuring a full hands-on hacking session led by the esteemed Mr. Ankit Singh, a renowned cybersecurity expert and a top 50 Bugcrowd hacker globally.   
                </p>
                <br />
                <NavLink  className="text-light-green-300 underline " to={paths.hackershorizon}>Read more here...</NavLink>
                <br />
           ...
           <div class="flex md:contents">
            ...
            <div class="bg-transparent  text-white  col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              ...
              >
                <p>
                  <b className="text-blue-gray-600">lug@vitc:~/events$ </b>{" "}
                  <b className="text-light-green-300">sudo LinuxInstallationBooth </b>
                </p>
                {/* <br />   */}
                <p>
                  <b className="text-blue-gray-600">
                ...
                <p>The Linux Club demonstrated its commitment to promoting open-source technology with the successful organization of "Linux Installation Booth 2.0" on 12th May 2023. This initiative aimed to break down barriers for students, offering assistance in installing Linux OS and setting up dual-boot systems.   
                </p>
                <br />
                <NavLink  className="text-light-green-300 underline " to={paths.linuxInstallationBooth2}>Read more here...</NavLink>
                <br />
          ...
          <div class="flex flex-row-reverse md:contents">
            <div class="bg-transparent  text-white  col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              >
                ...
                <p>"Password", held on 8th and 9th June 2023, transcended the ordinary, offering participants a cybersecurity marathon across three dynamic sessions. The event's first day, orchestrated by the Technical department, set the tone with immersive workshops that provided a deep dive into the intricacies of cybersecurity.   
                </p>
                <br />
                <NavLink  className="text-light-green-300 underline " to={paths.password2023}>Read more here...</NavLink>
                <br />
          ...
          <div class="flex md:contents">
            ...
            <div class="bg-transparent  text-white  col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              ...
              >
                ...
                <p>Cyber-0-Day 2.0, the pinnacle event of Technovit, embarked our future hackers on an enthralling journey deep into the realms of cybersecurity. Staged at the majestic Netaji Auditorium, this 24-hour tech marathon was nothing short of perfection.   
                </p>
                <br />
                <NavLink  className="text-light-green-300 underline " to={paths.cyberOday2}>Read more here...</NavLink>
                <br />
